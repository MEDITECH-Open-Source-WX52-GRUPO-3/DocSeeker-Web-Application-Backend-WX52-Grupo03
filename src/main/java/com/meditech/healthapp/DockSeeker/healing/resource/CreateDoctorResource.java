...
public class CreateDoctorResource {
    ...
    private List<NewAvailableHoursResource> hoursAvailable;
    private List<NewEducationResource> education;
}
...
@NoArgsConstructor
@AllArgsConstructor
class NewAvailableHoursResource {
